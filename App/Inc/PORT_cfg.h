...
#define FTM0_CH4_PIN    PTD4        //PTD4、PTA7   //左
#define FTM0_CH5_PIN    PTD5        //PTD5、PTA0   //右     PTA0不要用（与Jtag、SWD冲突）
...
//      模块通道    端口          可选范围              建议
#define I2C0_SCL_PIN    PTB2        // PTB0、PTB2、PTD8
#define I2C0_SDA_PIN    PTB3        // PTB1、PTB3、PTD9
